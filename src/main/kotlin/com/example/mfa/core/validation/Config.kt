...
@Target(AnnotationTarget.CLASS)
@Retention(AnnotationRetention.RUNTIME)
@Constraint(validatedBy = [MustOnlyOneOfValidator::class])
annotation class MustOnlyOneOf(
    val fields: Array<String>,
    val message: String = "Exactly one of the specified fields must be provided.",
    val groups: Array<KClass<*>> = [],
    val payload: Array<KClass<out Payload>> = []
)